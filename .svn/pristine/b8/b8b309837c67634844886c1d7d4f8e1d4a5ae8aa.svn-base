...
public class TeacherTestSchoolListAdapter extends CommonAdapter<TestRoom> {
    public TeacherTestSchoolListAdapter(Context context, List<TestRoom> list) {
        super(context, list, R.layout.item_test);
    }

    @Override
    public void getView(ViewHolder holder, TestRoom data, int pos) {
        holder.setText(R.id.tv_test_time,data.getSchoolName());
